...
<div class="p-5 mb-4 bg-light rounded-3">
    <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">Predaj filmov | Drama</h1>
    </div>
</div>
<h1 class="my-4 text-center">Drama kategória</h1>
<div class="row row-cols-1 row-cols-md-4 g-4">
    <?php
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo '<div class="col col-sm"><div class="card mr-4" style="width: 20rem;">
